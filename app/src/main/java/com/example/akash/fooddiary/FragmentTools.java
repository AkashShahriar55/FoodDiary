...
public class FragmentTools extends Fragment
    ...
    RelativeLayout bmrtool;
    RelativeLayout bdyfattool;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bmrtool = view.findViewById(R.id.bmr);
        bdyfattool = view.findViewById(R.id.bodyfat);
        bmrtool.setOnClickListener(this);
        bdyfattool.setOnClickListener(this);
        return view;
    }
    ...
    public void onClick(View v) {
        ...
        else if(v.getId()==R.id.bodyfat){
            Intent intent= new Intent(getActivity(),BodyFatCalculator.class);
            startActivity(intent);
        }
    }
